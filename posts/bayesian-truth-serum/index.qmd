...
[^11] relies on several assumptions for constructing BTS algorithm:

[^11]: 2004 A Bayesian Truth Serum For Subjective Data

Bayesian Nash equilibrium

"Truth-telling is individually and collectively optimal"[^12]. Taking into account the BTS assumptions, agents stating their true preferences is BTS Nash equilibrium for any α\>0. Thus, it is individually optimal as BTS Nash equilibrium results in a maximum expected payoff. It is collectively optimal because there is no other equilibrium which results in a higher information score for any agent. The equilibrium relies on two assumptions:

[^12]: 2004 A Bayesian Truth Serum For Subjective Data
